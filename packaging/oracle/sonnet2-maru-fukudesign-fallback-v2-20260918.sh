...
REQ=maru-fukudesign-fallback-inquiry-20260918-2
...
PY
  ...
  if [[ "$attempt" == 6 ]]; then stop "safety_stale_after_wait:$AGE"; fi
  sleep 10
done
...
RID="maru-fukudesign-fallback-inquiry-20260918-2"
