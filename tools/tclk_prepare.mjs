// No-POST bridge used only by the signer-side tclk PREPARE process.
// It returns freshly minted hash-lock material only to its parent process, which
